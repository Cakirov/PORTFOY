...
export function CoordinateReadout() {
  ...
  return (
    <div
      aria-hidden="true"
      className={`fixed right-5 bottom-5 z-50 hidden border border-border-strong bg-bg/85 px-2.5 py-1.5 text-label-sm tracking-wide text-text-tertiary backdrop-blur-md transition-opacity duration-300 lg:block ${
