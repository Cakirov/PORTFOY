...
/**
 * lucide-react no longer ships brand/logo marks. These two small inline
 * SVGs (standard, widely-used monochrome brand glyphs) fill that gap so
 * social links keep a recognizable icon — same prop shape as a lucide icon.
 */
